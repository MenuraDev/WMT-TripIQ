...
export default function DriverLoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      router.replace('/(tabs)/driver'); // Go to driver dashboard after login
    } catch (error: any) {
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.footer}>
          ...
          <TouchableOpacity onPress={() => router.push('/auth/driver-register' as any)}>
