...
export default function DriverRegisterScreen() {
  ...
  const handleRegister = async () => {
    if (!name || !email || !password || !licenseNumber) {
      Alert.alert('Error', 'Please fill in all required fields including License Number');
      return;
    }
    ...
    setIsLoading(true);
    try {
      await register(name, email, password, licenseNumber, phone || undefined);
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.content}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Join TripIQ and earn on your schedule</Text>
          </View>
