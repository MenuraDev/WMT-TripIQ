...
const createStyles = (theme) => StyleSheet.create({
  ...
  loadingText: { marginTop: 12, color: theme.textSecondary, fontSize: 13, fontFamily: 'Inter' },
  scrollContent: { padding: 16, paddingBottom: 96 },
  statsRow: { flexDirection: 'row', gap: 10, marginBottom: 16 },
  statCard: { flex: 1, borderWidth: 1, borderColor: theme.borderLight, backgroundColor: theme.bgSurface, borderRadius: 12, padding: 12 },
  statLabel: { color: theme.textMuted, fontSize: 11, fontFamily: 'Inter', marginBottom: 4 },
  statValue: { color: theme.textPrimary, fontSize: 18, fontFamily: 'Inter', fontWeight: '700' },
  statValueSmall: { color: theme.textPrimary, fontSize: 13, fontFamily: 'monospace', fontWeight: '700' },
  segmented: { flexDirection: 'row', backgroundColor: theme.bgSurface, borderWidth: 1, borderColor: theme.borderLight, borderRadius: 12, padding: 4, marginBottom: 18 },
  ...
  segmentText: { color: theme.textSecondary, fontSize: 12, fontFamily: 'Inter', fontWeight: '600' },
  segmentTextActive: { color: '#FFFFFF', fontSize: 12, fontFamily: 'Inter', fontWeight: '700' },
  sectionTitle: { color: theme.textPrimary, fontSize: 16, fontFamily: 'Inter', fontWeight: '700', marginBottom: 10 },
  ...
  emptyBox: { alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: theme.borderLight, backgroundColor: theme.bgSurface, borderRadius: 14, padding: 22, marginBottom: 16 },
  emptyTitle: { color: theme.textPrimary, fontSize: 15, fontFamily: 'Inter', fontWeight: '700', marginTop: 8 },
  ...
  bookingChip: { minWidth: 170, borderWidth: 1, borderColor: theme.borderLight, backgroundColor: theme.bgPrimary, borderRadius: 12, padding: 12, marginRight: 10 },
  bookingChipActive: { backgroundColor: theme.primaryLight, borderColor: theme.primaryMid },
  bookingChipTitle: { color: theme.textPrimary, fontSize: 13, fontFamily: 'Inter', fontWeight: '700' },
  bookingChipTitleActive: { color: theme.primaryDark, fontSize: 13, fontFamily: 'Inter', fontWeight: '700' },
  bookingChipMeta: { color: theme.textSecondary, fontSize: 12, fontFamily: 'monospace', marginTop: 5 },
  bookingChipMetaActive: { color: theme.primaryDark, fontSize: 12, fontFamily: 'monospace', marginTop: 5 },
  summaryCard: { borderWidth: 1, borderColor: theme.borderLight, backgroundColor: theme.bgSurface, borderRadius: 14, padding: 14, marginBottom: 16 },
  summaryTitle: { color: theme.textPrimary, fontSize: 16, fontFamily: 'Inter', fontWeight: '700' },
  summaryMeta: { color: theme.textSecondary, fontSize: 12, fontFamily: 'Inter', marginTop: 4 },
  ...
  methodButton: { flex: 1, borderWidth: 1, borderColor: theme.borderLight, backgroundColor: theme.bgPrimary, borderRadius: 12, paddingVertical: 10, alignItems: 'center' },
  methodButtonActive: { backgroundColor: theme.primaryLight, borderColor: theme.primaryMid },
  ...
  savedCardOption: { borderWidth: 1, borderColor: theme.borderLight, borderRadius: 12, backgroundColor: theme.bgPrimary, padding: 12, flexDirection: 'row', alignItems: 'center' },
  savedCardOptionActive: { borderColor: theme.primary, backgroundColor: theme.bgSurface },
  cardBrand: { color: '#0C6EFD', fontSize: 12, fontFamily: 'Inter', fontWeight: '800', marginRight: 10 },
  cardMasked: { color: theme.textPrimary, fontSize: 14, fontFamily: 'monospace', fontWeight: '700', flex: 1 },
  defaultText: { color: '#145C32', fontSize: 11, fontFamily: 'Inter', fontWeight: '700' },
  formCard: { borderWidth: 1, borderColor: theme.borderLight, backgroundColor: theme.bgPrimary, borderRadius: 14, padding: 14, marginBottom: 16 },
  cardPreview: { borderWidth: 1, borderColor: theme.borderLight, backgroundColor: theme.bgSurface, borderRadius: 12, padding: 14, minHeight: 96, justifyContent: 'space-between', marginBottom: 12 },
  previewBrand: { color: '#0C6EFD', fontSize: 12, fontFamily: 'Inter', fontWeight: '800' },
  previewNumber: { color: theme.textPrimary, fontSize: 17, fontFamily: 'monospace', fontWeight: '700', marginTop: 18 },
  previewExpiry: { color: theme.textSecondary, fontSize: 12, fontFamily: 'monospace', alignSelf: 'flex-end' },
  ...
  cardItem: { borderWidth: 1, borderColor: theme.borderLight, backgroundColor: theme.bgPrimary, borderRadius: 14, padding: 14, marginBottom: 12 },
  ...
  nicknameText: { color: theme.textSecondary, fontSize: 12, fontFamily: 'Inter', marginBottom: 12 },
  nicknameRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  nicknameInput: { flex: 1, marginBottom: 10 },
  iconButton: { width: 44, height: 44, borderWidth: 1, borderColor: theme.borderLight, borderRadius: 12, alignItems: 'center', justifyContent: 'center', marginBottom: 10 },
  cardActions: { flexDirection: 'row', borderTopWidth: 1, borderTopColor: theme.borderLight, paddingTop: 12 },
  textAction: { marginRight: 16 },
  textActionBlue: { color: '#0C6EFD', fontSize: 12, fontFamily: 'Inter', fontWeight: '700' },
  textActionMuted: { color: theme.textSecondary, fontSize: 12, fontFamily: 'Inter', fontWeight: '700' },
  textActionDanger: { color: '#DC2626', fontSize: 12, fontFamily: 'Inter', fontWeight: '700' },
  paymentRow: { flexDirection: 'row', borderWidth: 1, borderColor: theme.borderLight, backgroundColor: theme.bgPrimary, borderRadius: 14, padding: 12, marginBottom: 10 },
